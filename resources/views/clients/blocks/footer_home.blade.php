                           ...
                           <div class="footer-widget footer-text">
                               <div class="footer-logo mb-25">
                                   <a href="{{ route('home') }}"><img
                                           src="{{ asset('clients/assets/images/logos/logo.png') }}" alt="Logo"></a>
                               </div>
                           ...
                           <div class="footer-widget footer-contact">
                               ...
                               <ul class="list-style-one">
                                   ...
                                   <li><i class="fal fa-envelope"></i> <a
                                           href="mailto:sangb2306638@student.ctu.edu.vn">sangb2306638@student.ctu.edu.vn</a>
                                   </li>
                                   <li><i class="fal fa-clock"></i> Mon - Fri, 08am - 05pm</li>
                                   <li><i class="fal fa-phone-volume"></i> <a
                                           href="callto:+88012334588">0899999999</a></li>
                               </ul>
                           </div>
                       </div>
                   </div>
       ...
       <script>
           $(document).ready(function() {
               ...
               @if (session('success_logout'))
                   toastr.success("{{ session('success_logout') }}");
               @endif
